...
const Home = () => {
    ...
    <section class="intro">
        <header>
            <h1>Anika Anjum Kochi</h1>
            <p>Genetic Engineering and Biotechnology   </p>
            <ul class="actions">
                <li><a href="#first" class="arrow scrolly"><span class="label">Next</span></a></li>
            </ul>
        </header>
        <div class="content">
            <span class="image fill" data-position="center"><img src={one} alt="" /></span>
        </div>
    </section>
    ...
    <div class="copyright">&copy; Untitled. All rights reserved. Design: <a href="https://html5up.net">HTML5 UP</a>. Distributed by <a href="https://themewagon.com/">ThemeWagon</a></div>
